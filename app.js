...
let veryOldInventors = inventors.filter((born) => {
...
let inventorNames = inventors.map((allName) => {
  return `first: ${allName.first}, and last : ${allName.last}`
})
...
// Complete the exercise in the space below:
inventorNamedAda = inventors.find((namaAda) => {
  return namaAda.first === 'Ada'
})
// Check your work:
...
firstLast = people.map((names) => {
  joinNames = names.split(',', 2)
  return `${joinNames[1]} ${joinNames[0]} `
})
// Check your work:
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((allAdults) => {
  age = 2024 - devs.year
  return age > 19
})
// Check your work:
...
// Complete the exercise in the space below:
commentById = comments.find((certinId) => {
  return certinId.id === 823423
})
// Check your work:
...
// Complete the exercise in the space below:
idx = comments.findIndex((specificId) => {
  return specificId.id === 123523
})
// Check your work:
